"""multireligionval_30247 URL Configuration
...
admin.site.site_header = "Multireligionval"
admin.site.site_title = "Multireligionval Admin Portal"
admin.site.index_title = "Multireligionval Admin"

# swagger
api_info = openapi.Info(
    title="Multireligionval API",
    default_version="v1",
    description="API documentation for Multireligionval App",
)
